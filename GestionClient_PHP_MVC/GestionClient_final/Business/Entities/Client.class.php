 ...
 * Entité Client
 * 
 * Représente à la fois un utilisateur et un propriétaire éventuel de bons de commande
...
class Client extends Entity {
	...
	// attributs : identiques aux noms de champs dans la base
	...
	// regex de validation des attributs
